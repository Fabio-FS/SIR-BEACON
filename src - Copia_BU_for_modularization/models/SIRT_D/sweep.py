...
from .dynamic import sim_SIRTD_final, StateType
from ...utils.batch_sweep import batch_sweep_maskSIRD  # We can reuse this since the structure is the same
...
def sweep_pol_SPB_SIRTD(
    ...
    """Sweep over testing rate (SPB) and polarization values for the disconnected SIRT model
    
    Args:
        test_max_range: Dictionary defining range for maximum testing rate
