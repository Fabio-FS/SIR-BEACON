...
def batch_sweep_maskSIRD(
    ...
    """Batch sweep function specifically for maskSIR_D model
    
    Args:
        simulation_fn: The simulation function to run
        param_ranges: Array of parameter combinations to sweep over
        base_params: Base parameter dictionary
        n_steps: Number of time steps
        batch_size: Size of batches for parallel execution
        param_updater: Function to update parameters for each sweep point
